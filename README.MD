...
All Docker-related files are in `docker/`. The image is based on `php:8.4-apache` and includes all required PHP extensions (`curl`, `apcu`, `ldap`, `ssh2`). Build and run from the project root:

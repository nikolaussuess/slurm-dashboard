...
But currently none of these features is under active development. I will, however, make this dashboard compatible with slurm 26.x, which requires adding compatibility for REST API v0.0.43.
